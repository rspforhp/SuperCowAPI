...
namespace SuperCowAPI.Template.Configuration;
...
public class ConfiguratorMixinBase
{
    ...
    public virtual IUpdatableConfigurable[] MakeConfigurations(string configFolder)
    {
        ...
        {
            Configurable<SuperCowAPI.Configuration.Config>.FromFile(Path.Combine(configFolder, "Config.json"), "Default Config")
        };
    }
