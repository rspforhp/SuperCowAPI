...
namespace SuperCowAPI.Template;
...
public class Startup : IMod
{
    ...
    /// </summary>
    private SuperCowAPI.Configuration.Config _configuration = null!;
    ...
    public void StartEx(IModLoaderV1 loaderApi, IModConfigV1 modConfig)
    {
        ...
        _configuration = configurator.GetConfiguration<SuperCowAPI.Configuration.Config>(0);
    ...
    private void OnConfigurationUpdated(IConfigurable obj)
    {
        ...
        */
        ...
        _configuration = (SuperCowAPI.Configuration.Config)obj;
